...
* Use the shortcut <kbd>command</kbd> + <kbd>shift</kbd> + <kbd>L</kbd>.
...
* Use the shortcut <kbd>option</kbd> + <kbd>shift</kbd> + <kbd>command</kbd> + <kbd>R</kbd>.
...
The function `document()` will automatically create the function documentation. Use `load_all()` to load your package locally
...
* Use the shortcut <kbd>shift</kbd> + <kbd>command</kbd> + <kbd>E</kbd>.
...
This section provides a step-by-step guide on how to set up a new project on GitHub or GitLab, link it to your RStudio, and use basic Git commands for version control. The example is using GitHub but is very similar for GitLab.
...
Open the `README` file in RStudio and make a change (e.g., add a new line).
