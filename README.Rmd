...
This section provides a step-by-step guide on how to (1) set up a new project on GitHub or GitLab, (2) link it to your RStudio, and (3) use basic git commands for version control. The example is using GitHub but is very similar for GitLab.
